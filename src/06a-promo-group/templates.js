...
export const TEMPLATE_OPTIONS_PRO = [['nhsblocks/promo1']];
export const GRID_OPTIONS = [
	{
		...
		innerBlocks: [['nhsblocks/onehalfpro'], ['nhsblocks/onehalfpro']],
	},
	{
		name: 'threecolspro',
	...
	},
	{
		...
		innerBlocks: [['nhsblocks/onethirdpro'], ['nhsblocks/twothirdspro']],
	},
	{
		name: 'two3one3pro',
		label: __('Two Thirds / One Third Columns Promos', 'nhsblocks'),
		icon: Icons.tworightthirdIcon,
		innerBlocks: [['nhsblocks/twothirdspro'], ['nhsblocks/onethirdpro']],
	},
	{
		name: 'one4one2one4pro',
		label: __(
			'One Quarter / One Half / One Quarter Columns Promos',
			'nhsblocks'
		),
	...
	},
	{
		...
		label: __(
			'One Quarter / One Quarter / One Half Columns Promos',
			'nhsblocks'
		),
	...
	},
	{
		name: 'one2one4one4',
		label: __(
			'One Half / One Quarter / One Quarter Columns Promos',
			'nhsblocks'
		),
