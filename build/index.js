...
/***/ "./src/12-contents-list/contents-list-page.js":
/*!****************************************************!*\
  !*** ./src/12-contents-list/contents-list-page.js ***!
  \****************************************************/
/*! no exports provided */
...
var _wp$components = wp.components,
    ...
    TextControl = _wp$components.TextControl; // Register Block
...
registerBlockType('nhsblocks/contentslistpage', {
  ...
  keywords: [__('Contents List Page', 'nhsblocks'), __('Navigation', 'nhsblocks'), __('Related sections on page', 'nhsblocks')],
  edit: withSelect(function (select) {
    ...
    var blocks = _ref.blocks,
        ...
        h2titles = _ref.attributes.h2titles;
    var dynamicArray = [];
    blocks.map(function (block, i) {
      if (block.name === "core/heading" && block.attributes.level === 2) {
        var anchor = 'nhs-block-anchor-' + i;
        dynamicArray.push({
    ...
    var updateHeading = function updateHeading() {
      setAttributes({
        h2titles: dynamicArray
      });

      for (var i = dynamicArray.length - 1; i >= 0; i--) {
        var block = select('core/block-editor').getBlock(dynamicArray[i].id);
        block.attributes.anchor = dynamicArray[i].url;
      }
    };

    var is_same = h2titles.length == dynamicArray.length && h2titles.every(function (element, index) {
      return dynamicArray[index].text === element.text && dynamicArray[index].url === element.url;
    });
    console.log(h2titles, dynamicArray); //let is_same = false;

    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("nav", {
      className: "{ className } nhsuk-contents-list",
      role: "navigation",
      "aria-label": "Pages in this guide"
    }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("h2", {
      className: "nhsuk-u-visually-hidden"
    }, __('Contents', 'nhsblocks')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("ol", {
      className: "nhsuk-contents-list__list"
    }, h2titles ? h2titles.map(function (block) {
    ...
    }) : Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("p", null, "Press the button below to make a table of contents for this page"), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("p", null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(Button, {
  ...
  save: function save(props) {
    var h2titles = props.attributes.h2titles;
    return null;
  }
});
...
var _wp$blockEditor = wp.blockEditor,
    ...
    InnerBlocks = _wp$blockEditor.InnerBlocks;
var Fragment = wp.element.Fragment;
var TextControl = wp.components.TextControl; // Register Block
...
registerBlockType('nhsblocks/contentslist', {
  ...
  category: 'nhsblocks',
  icon: 'editor-ul',
  keywords: [__('Contents List', 'nhsblocks'), __('Navigation', 'nhsblocks'), __('Related pages', 'nhsblocks')],
  edit: function edit(props) {
    var className = props.className,
        setAttributes = props.setAttributes,
        title = props.attributes.title;
    var TEMPLATE_OPTIONS = [['nhsblocks/contentslistitem', {}]];
    var ALLOWED_BLOCKS = ['nhsblocks/contentslistitem'];
...
registerBlockType('nhsblocks/contentslistitem', {
  ...
  edit: function edit(props) {
    ...
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("li", {
      className: "nhsuk-contents-list__item"
    }, isSelected ? Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(TextControl, {
    ...
    })) : Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(Fragment, null, url ? Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("a", {
      className: "nhsuk-contents-list__link",
      href: "{ url }"
  ...
  save: function save(props) {
    ...
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(Fragment, null, url ? Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("li", {
      className: "nhsuk-contents-list__item"
    }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("a", {
      className: "pagename nhsuk-contents-list__link",
      href: url
    }, text)) : Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("li", {
      className: "nhsuk-contents-list__item",
      "aria-current": "page"
    }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("span", {
      className: "pagename nhsuk-contents-list__current"
    }, text)));
  }
});
...
/* harmony import */ var _12_contents_list__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./12-contents-list */ "./src/12-contents-list/index.js");
/* harmony import */ var _12_contents_list_contents_list_page__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./12-contents-list/contents-list-page */ "./src/12-contents-list/contents-list-page.js");
/**
